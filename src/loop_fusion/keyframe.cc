...
{
    // cout << "create keyframe -> " << _index << endl;
	m_camera = CameraFactory::instance()->generateCameraFromYamlFile("config/kaist/cam0_pinhole_38-39.yaml");
...
void KeyFrame::computeBRIEFPoint()
{
	...
	// cout << "brief_descriptors.size() = " << brief_descriptors.size() << endl;
